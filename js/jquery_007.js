    ...
    validate: function(options) {
      ...
      if (validator.settings.onsubmit) {
        ...
        this.validateDelegate(":submit", "click", function(event) {
          ...
          // allow suppressing validation by adding the html5 formnovalidate attribute
          // to the submit button
          // NOTE: James Skinner: disabled this for IE 6-8 because of $.attr's flakiness
          if (event.target.properties && $(event.target).attr("formnovalidate") !== undefined) {
            validator.cancelSubmit = true;
          }
        });
